# Linux S3FS Utilities & Bootstraps | AWS Migration ©<img src="https://github.com/RMelanson/linux-scripts-bootstraps/blob/master/images/boot1.png" width="6%" align= "right">
...
- The s3fsBootstrap.sh is used to download ??????? from the git repository for ...e bootstraps from the git repository for future potential installation (see section below).
 - - - -
